...
const LogIn = (props: Props) => {
    ...
    return (
        <div className="my-[7vh] md:my-[10vh] w-full md:max-w-xl mx-auto">
            <form action="submit" onSubmit={submit} className="flex flex-col mx-2 p-6 bg-gray-900 rounded-md shadow-xl">
                <h1 className="font-semibold mb-2 text-3xl uppercase tracking-widest">Log In</h1>
                ...
                <div className="mb-3">
                    ...
                    {!isValidEmail && email.length > 0 ? (
                        <p className="mt-1 text-error text-xs italic text-red-500">Enter Valid Email</p>
                    ) : (
                        ""
                    )}
                </div>
                ...
                <div className="flex grid-cols-3 gap-4 items-center mt-4">
                    {/* TODO:Google Icon */}
                    {/* <button className="form-btn" onClick={signInWithGoogle}> Sign In with Google </button> <div className="font-semibold">OR</div> */}
                    {/* Submit Button */}
                ...
                {/* <Link href="/forgot-password" className="block mt-2 text-center text-red-500 font-semibold"> Forgot Password? </Link> */}
                <div>
